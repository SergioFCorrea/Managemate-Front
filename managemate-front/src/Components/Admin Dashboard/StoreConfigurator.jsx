...
const StoreConfigurator = () => {
	...
	const [saleChannels, setSaleChannels] = useState(["wpp", "fb"]);
	return (
		<div>
				...
				<NavbarContent as="div" justify="end">
					<Dropdown
						...
						<DropdownMenu aria-label="Profile Actions" variant="shadow">
							...
							<DropdownItem key="system">Go to store manager</DropdownItem>
					...
					<form
						...
						<div className="w-full flex flex-col justify-center items-center md:flex-row gap-8">
							...
							<div className="md:w-1/2 flex flex-col justify-center items-center gap-8 md:mb-8">
								...
								/>
								<Textarea
									value="La descripcion de la tienda sisisisisi"
									maxRows="4"
									classNames={{
