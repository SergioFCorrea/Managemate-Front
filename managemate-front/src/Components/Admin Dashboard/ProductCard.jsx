...
function ProductCard({product}) {
	...
	return (
		<div className="w-[180px] h-auto flex flex-col justify-center md:justify-between items-center bg-[#3d1d93] rounded-lg overflow-hidden">
			<div className="relative w-full h-auto flex flex-col justify-start items-center">
				<img
					src={product.image}
					alt=""
					className="object-cover w-full md:w-[180px] h-auto shadow-[0_4px_10px_0_rgba(0,0,0,0.3)]"
				/>
