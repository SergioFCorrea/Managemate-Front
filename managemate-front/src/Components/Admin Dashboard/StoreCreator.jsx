		...
		<div>
			{/* <Navbar maxWidth="xl" className="md:bg-[#EBD5C4] justify-center flex">
				...
				<NavbarContent
					...
					<NavbarItem className="" justify="center">
						<Dropdown className="bg-[#3D1D93] text-white shadow-[4px_4px_12px_2px_rgba(0,0,0,0.8)] font-[Satoshi]">
							<NavbarItem>
								<DropdownTrigger>
									<Button
										disableRipple
										className="p-0 bg-transparent data-[hover=true]:bg-transparent font-[Satoshi] text-[#EBD5C4] md:text-[#232529]"
										radius="sm"
										variant="light">
										Account's Name
										<svg
											className="w-10 h-auto  fill-[#EBD5C4] md:fill-[#232529]"
			...
			<div className="flex flex-col justify-center items-center gap-8 mb-8">
				<div className="w-[85vw] md:w-[680px] lg:w-[1000px] gap-8 md:gap-16 h-auto flex flex-col justify-center items-center">
					...
					<form
						onSubmit={() => alert("Store created")}
						className="bg-none border-5 rounded-[20px] w-full h-auto md:w-[600px] md:h-auto border-[#ebd5c4] flex flex-col justify-center items-center px-5 py-10 md:p-9 gap-8">
						<div className="w-full flex flex-col justify-center items-center md:flex-row gap-12">
							<img
								...
								alt=""
								className="w-[180px] h-auto rounded-[10px] object-cover"
							/>
							...
							<div className="w-full md:w-[300px] flex flex-col justify-center items-center gap-8 mt-8 md:mt-0">
								...
								<Dropdown>
									<DropdownTrigger>
										<Button
											radius="sm"
											className="bg-[#EBD5C4] font-[Satoshi-Bold] text-[#232529] w-[125px] text-sm justify-between">
											{selectedValue}
											<svg
