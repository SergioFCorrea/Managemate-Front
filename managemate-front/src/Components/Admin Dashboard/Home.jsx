	...
	return (
		<div className="flex flex-col justify-center items-center">
			<Navbar
				...
				<NavbarMenu>
					<Link className="w-full font-[Satoshi-Bold]">Home</Link>
					<Link className="w-full font-[Satoshi-Bold]">Statistics</Link>
					<Link className="w-full font-[Satoshi-Bold]">Clients</Link>
					<Link className="w-full font-[Satoshi-Bold]">Orders</Link>
					<Link className="w-full font-[Satoshi-Bold]">Inventory</Link>
				</NavbarMenu>
				...
				<div className="flex flex-col justify-center items-center md:flex-row w-full gap-12">
					<div className="w-full md:w-[500px] md:h-[230px] h-[250px] rounded-[30px] bg-[#3D1D93] flex flex-col justify-center items-center shadow-[4px_4px_18px_3px_rgba(0,0,0,0.6)] gap-4 ">
						...
						<img
							src="https://res.cloudinary.com/dlmqrbnli/image/upload/v1697155921/my%20images/IMG_4238_vbiv48.jpg"
							alt=""
							className="w-36 h-auto rounded-[18px] shadow-[0_0_18px_0_rgba(0,0,0,0.8)]"
						/>
					</div>
					<div className="w-full md:w-[500px] md:h-[230px] h-[250px] rounded-[30px] bg-gradient-to-br from-black to-[#383C42]  flex flex-col justify-center items-center shadow-[4px_4px_18px_3px_rgba(0,0,0,0.6)] gap-8 ">
						...
						<p className="font-[Poppins] font-medium text-6xl text-[#EBD5C4]">
							$35
						</p>
					</div>
					<div className="w-full h-[300px] md:h-[230px] rounded-[30px] bg-gradient-to-br from-black to-[#383C42] flex flex-col justify-center items-center shadow-[4px_4px_18px_3px_rgba(0,0,0,0.6)] gap-8 md:gap-6 mb-8 md:mb-0">
						...
						<div className="flex justify-center items-center w-52 md:w-64 gap-3">
							...
							<Progress
								...
								radius="sm"
								classNames={{
									track: "bg-zinc-800 shadow-[4px_0_18px_0_rgba(0,0,0,0.6)]",
									indicator: "bg-gradient-to-br from-[#3d1d93] to-[#9477E4]",
								}}
							/>
							<p className="text-[#C8D9FF] text-[13px] font-[Questrial]">50%</p>
						</div>
						<div className="flex justify-center items-center w-52 md:w-64 gap-3">
							<svg
								className="h-8 w-8 fill-white"
							...
							/>
							<p className="text-[#C8D9FF] text-[13px] font-[Questrial]">25%</p>
						</div>
						<div className="flex justify-center items-center w-52 md:w-64 gap-3">
							<svg
								className="h-8 w-8 fill-white"
