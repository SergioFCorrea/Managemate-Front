		...
		<div>
			...
			<div className="flex flex-col items-center gap-8">
				...
				<p className="font-[Questrial] text-sm text-white w-[30ch] md:w-[90ch] lg:w-auto">
					...
					clients and get detailed information sorted by a specific month (pro
					version required)
				</p>
					...
					<div className="w-full md:w-full flex justify-between items-center mb-6 md:mb-0">
						...
						<Dropdown>
							...
							<DropdownMenu
								...
								<DropdownItem key="Select month">Select month</DropdownItem>
								<DropdownItem key="January">January</DropdownItem>
								<DropdownItem key="Febuary">February</DropdownItem>
								<DropdownItem key="March">March</DropdownItem>
								<DropdownItem key="April">April</DropdownItem>
								<DropdownItem key="May">May</DropdownItem>
								<DropdownItem key="June">June</DropdownItem>
								<DropdownItem key="July">July</DropdownItem>
								<DropdownItem key="August">August</DropdownItem>
								<DropdownItem key="September">September</DropdownItem>
								<DropdownItem key="October">October</DropdownItem>
								<DropdownItem key="November">November</DropdownItem>
								<DropdownItem key="December">December</DropdownItem>
							</DropdownMenu>
						</Dropdown>
					</div>
					...
					<div className="w-full flex flex-col md:flex-row justify-center items-center gap-8 mb-8">
						<div className="w-full lg:w-[250px] h-[250px] rounded-[25px] bg-[#3D1D93] flex flex-col justify-center items-center shadow-[4px_4px_18px_3px_rgba(0,0,0,0.6)] gap-4 ">
							...
							<img
								src="https://res.cloudinary.com/dlmqrbnli/image/upload/v1697155921/my%20images/IMG_4238_vbiv48.jpg"
								alt=""
								className="w-36 h-auto rounded-lg shadow-[0_0_18px_0_rgba(0,0,0,0.8)]"
							/>
							<p className="font-[Poppins] text-white text-sm">@makima</p>
						</div>
						...
						<div className="inner-shadow-2 w-full h-[300px] md:h-[250px] flex flex-col justify-center items-center md:w-[450px] bg-[#232529] rounded-[30px] lg:py-4">
							...
							<div className="w-full h-[80%] flex lg:flex-col justify-center items-center md:gap-5">
								<div className="w-16 lg:w-auto flex flex-col lg:flex-row-reverse justify-center gap-16 lg:gap-4 items-center h-[200px] lg:h-auto ">
									<p className="text-sm font-[Questrial] text-white">50%</p>
									<Progress
										value={50}
										size="lg"
										radius="sm"
								...
								<div className="w-16 lg:w-auto flex flex-col lg:flex-row-reverse justify-center gap-16 lg:gap-4 items-center h-[200px] lg:h-auto ">
									<p className="text-sm font-[Questrial] text-white">44%</p>
									<Progress
										value={44}
										size="lg"
										radius="sm"
								...
								<div className="w-16 lg:w-auto flex flex-col lg:flex-row-reverse justify-center gap-16 lg:gap-4 items-center h-[200px] lg:h-auto ">
									<p className="text-sm font-[Questrial] text-white">6%</p>
									<Progress
										value={6}
										size="lg"
										radius="sm"
